...
# Example usage
html_file = 'blogger_new_html/2020_ehime.html'  # Replace with the path to your HTML file
...
link_file = 'ehime_youtube_link.txt'  # Replace with the path to your link file
...
def replace_img_tags_and_iframe(html_file, output_file, youtube_links):
    ...
    for link in youtube_links:
        # Create the new div structure with the iframe
        new_div = soup.new_tag('div', style='text-align: center;')
        new_iframe = soup.new_tag('iframe', width='60%', height='315', src=link,
                                   frameborder='0',
                                   allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture',
                                   allowfullscreen='allowfullscreen')

        # Append the new iframe to the new div
        new_div.append(new_iframe)

        # Append the new div to the soup (you can choose where to place this)
        soup.body.append(new_div)  # Change as necessary to place the iframes correctly
