...
def count_files(folder_path):
    ...
    print("jpg: ",jpg_count)
    print("mp4: ",mp4_count)
    return jpg_count, mp4_count
    

# Example usage
address="2022_shimane_momiji"
html_file = f'blogger_new_html/{address}.html'  # Replace with the path to your HTML file
...
link_file = f'{address}_youtube.txt'  # Replace with the path to your link file
youtube_links = process_youtube_links(link_file)
jpg_count,mp4_count = count_files(f"/Users/china_108/Desktop/git_travel_blog/travel_blog/html_pics/{address}")

# Call the function to replace img and iframe tags
replace_img_tags_and_iframe(html_file, output_file, youtube_links)
#os.system(f'open github_html/{address}.html')
#os.system(f'open -a Xcode github_html/{address}.html')

#ryuoshima_youtube_link.txt,blogger_new_html/2020_ryuoshima.html
