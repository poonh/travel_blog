...
def replace_img_tags_and_stylesheet(html_file, output_file):
    ...
    img_tags_ctrip = re.findall(r'(<img\s[^>]*src=["\']https://dimg02\.c-ctrip\.com[^>]*>)', html_content)
    ...
    for idx, img_tag in enumerate(img_tags_ctrip, start=1):
        replacement = f'<div class="picture-container">\n    <img src="https://poonh.github.io/travel_blog/html_pics/2020_skiing/{idx}.JPG" class="picture">\n</div>\n<div style="text-align: center;"></div>'
...
# Example usage
html_file = 'blogger_new_html/2020_skiing.html'  # Replace with the path to your HTML file
