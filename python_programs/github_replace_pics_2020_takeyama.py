...
def replace_img_tags_and_stylesheet(html_file, output_file):
    ...
    # Remove <div class="separator"> tags but keep their inner content
    html_content = re.sub(r'<div class="separator"[^>]*>(.*?)</div>', r'\1', html_content, flags=re.DOTALL)

    # Regex to find all <img> tags with src from mafengwo and <img> tags with border attribute
    ...
    # Process the mafengwo image tags and replace them in the HTML content
    for idx, img_tag in enumerate(img_tags_ctrip, start=1):
        replacement = f'<div class="picture-container">\n    <img src="https://poonh.github.io/travel_blog/html_pics/2020_takeyama/{idx}.JPG" class="picture">\n</div>\n<div style="text-align: center;"></div>'
...
# Example usage
html_file = 'blogger_new_html/2020_takeyama.html'  # Replace with the path to your HTML file
